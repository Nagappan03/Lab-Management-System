...
<title>Add Release Request</title>
...
var releasedate=document.forms.releasedate.value;

if(reqList=="" ||releasedate=="")
	{
...
<body bgcolor="#2e86c1">
 ...
 <h3 align="center">Add Release Request</h3>
<form action="./AddLabReleaseServlet" method="post" name="forms" onSubmit="return validate()">
<table align="center">
...
<td>
Release Date:</td>
<td><input type="text"  name="releasedate" id="datepicker"/> </td></tr>
<tr>
<td>
