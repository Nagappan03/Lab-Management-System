 ...
 <link rel="stylesheet" type="text/css" href="HomePage.css">
    ...
    <BODY bgcolor=" #bfc9ca ">
     <%@ include file="headerPage.html" %> 
        <H3><center>View Extension Request</center></H3>
       <ul>
 
    <li>
      <a href="approveLabExtensionRequest.jsp">Approve lab Request</a></li>
     <li> <a href="declineLabExtensionRequest.jsp">Decline lab Request</a></li>
...
<br>
       ...
       Connection con=DriverManager.getConnection("jdbc:oracle:thin:@172.16.153.233:1521:xe", "user1", "techm123");
                    ...
                    rs =
                            statement.executeQuery("SELECT * FROM extension_request_details where approve_status='pending'");
                    while(rs.next())
                    {
        %>
