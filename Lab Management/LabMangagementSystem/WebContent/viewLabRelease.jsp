 ...
 <link rel="stylesheet" type="text/css" href="HomePage.css">
    ...
    <BODY bgcolor=" #bfc9ca ">
     <%@ include file="headerPage.html" %> 
        <H3><center>View Lab Release</center></H3>
       <ul>
 
    <li>
      <a href="approveLabReleaseRequest.jsp">Approve Lab Release Request</a></li>
     <li> <a href="declineLabReleaseRequest.jsp">Decline Lab Release Request</a></li>  
...
<br>
       ...
       Connection con=DriverManager.getConnection("jdbc:oracle:thin:@172.16.153.233:1521:xe", "user1", "techm123");
                    ...
                    rs =
                            statement.executeQuery("SELECT * FROM release_request_details where approve_status='Pending'");
                    while(rs.next())
                    {
        %>
