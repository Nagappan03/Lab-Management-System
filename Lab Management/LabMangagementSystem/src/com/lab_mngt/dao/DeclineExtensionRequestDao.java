...
public class DeclineExtensionRequestDao {
	...
	PreparedStatement pst=con.prepareStatement("update extension_request_details set approve_status='Not Approved' where req_id=?");
