...
public class OTMLoginDao {
    ...
    public int match(OTMLoginModel login) {
    	int result=0;
    	Connection con=null;
        System.out.println("match method of OTMLoginDAO class.....");
        ...
        try {
            ...
            PreparedStatement ps=con.prepareStatement("select * from OTMLogin where username=? and password=?");
