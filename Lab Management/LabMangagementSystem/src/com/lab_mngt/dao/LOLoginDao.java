...
public class LOLoginDao {
    ...
    public int match(LOLoginModel login) {
    	int result=0;
    	Connection con=null;
        System.out.println("match method of LOLoginDAO class.....");
        ...
        try {
            ...
            PreparedStatement ps=con.prepareStatement("select * from lologin where username=? and password=?");
          ...
          //result=ps.executeUpdate();
            ...
            while(rs.next()){
            	...
            	System.out.println(usrnameFromDb);
